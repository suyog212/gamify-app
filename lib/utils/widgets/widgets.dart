...
class AppTextField extends StatelessWidget {
  ...
  const AppTextField({super.key, required this.hintText, required this.controller, this.validator, this.prefix, this.suffix, this.isPass = false, required this.keyBoardType, this.label,this.isEnabled});
