...
class QuestionTile extends StatefulWidget {
  ...
  const QuestionTile({super.key, this.questionText, this.questionImg, this.questionNo});
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        FutureBuilder(
          future: mediaWidget(widget.questionImg ?? ""),
    ...
    if (regExp.hasMatch(link)) {
      ...
      if (await UrlTypeHelper.getType(link) == UrlType.image) {
        return InkWell(
            ...
            child: FittedBox(fit: BoxFit.fitWidth, child: Image.network(link)));
      }
