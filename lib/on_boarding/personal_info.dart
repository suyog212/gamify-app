...
class _PersonalInfoInputState extends State<PersonalInfoInput> {
  ...
  final TextEditingController _age = TextEditingController(
      text: Hive.box(userDataDB).get("personalInfo")['age']);
  final TextEditingController _phone = TextEditingController(
      text: Hive.box(userDataDB).get("personalInfo")['phone_no']);
  ...
  String? country = Hive.box(userDataDB)
      .get("personalInfo", defaultValue: {"country": null})["country"];
  String? state = Hive.box(userDataDB)
      .get("personalInfo", defaultValue: {"state": null})["state"];
  String? city = Hive.box(userDataDB)
                      ...
                      return Visibility(
                        ...
                        replacement: Center(
                          child: Padding(
                            ...
                            child: AutoSizeText.rich(
                                TextSpan(text: "Click on ", children: [
                              TextSpan(
                                  text: "\"+\"",
                                  style:
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final curr =
                                Hive.box(qualificationDataDB).getAt(index);
                            final key =
                                Hive.box(qualificationDataDB).keyAt(index);
                            return Slidable(
            ...
            if (Hive.box(userDataDB).get("interests") != null &&
              ...
              try {
                AuthHandler().saveUserData(
                    Hive.box(userDataDB).get("personalInfo")['user_id'],
                    _name.text,
                    _email.text,
                    _age.text,
                    "$city,$state,$country",
              ...
              snackBarKey.currentState?.showSnackBar(
                  const SnackBar(content: Text("Fill all data")));
            }
          },
