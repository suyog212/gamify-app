      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            AppTextField(hintText: "Name", controller: _name, keyBoardType: TextInputType.name,label: "Name",),
            const Divider(
              color: Colors.transparent,
            ),
            AppTextField(hintText: "Email", controller: _email, keyBoardType: TextInputType.emailAddress,label: "Email",),
            const Divider(
              color: Colors.transparent,
            ),
            AppTextField(hintText: "Age", controller: _age, keyBoardType: TextInputType.number,label: "Age",),
            const Divider(
              color: Colors.transparent,
            ),
            AppTextField(hintText: "Phone Number", controller: _phone, keyBoardType: TextInputType.number,label: "Phone Number",),
            const Divider(
              color: Colors.transparent,
            ),
            AutoSizeText("Address",style: Theme.of(context).textTheme.titleLarge,),
            ...
            const Divider(color: Colors.transparent,),
            ValueListenableBuilder(valueListenable: Hive.box(userDataDB).listenable(), builder: (context, value, child) {
              return Wrap(
                  runSpacing: 8,
                  spacing: 8,
                  children: List.generate(
                    interests.length,
                        (index) {
                      List<String> curr =
                      Hive.box(userDataDB).get("interests", defaultValue: <String>[]);
                                                ...
                                                children: [
                                                  ...
                                                  TextFormField(
                                                    ...
                                                    decoration: InputDecoration(
                                                        border: OutlineInputBorder(
                                                            borderRadius: BorderRadius.circular(10)),
                                                        label: const Text("School/College Name")),
                                                    validator: (value) {
                                                  ...
                                                  TextFormField(
                                                    ...
                                                    decoration: InputDecoration(
                                                        border: OutlineInputBorder(
                                                            borderRadius: BorderRadius.circular(10)),
                                                        label: const Text("University/Board Name")),
                                                    validator: (value) {
                                                      if (value == null || value.isEmpty) {
                                                  ...
                                                  TextFormField(
                                                    ...
                                                    decoration: InputDecoration(
                                                        border: OutlineInputBorder(
                                                            borderRadius: BorderRadius.circular(10)),
                                                        label: const Text("CGPA/Percentage")),
                                                    keyboardType: TextInputType.number,
                                                    validator: (value) {
                                                      if (value == null || value.isEmpty) {
                        ...
                        child: Padding(
                          ...
                          child: AutoSizeText.rich(TextSpan(
                              ...
                              children: [
                                ...
                                const TextSpan(text: " to add data.")
                              ]
                          )),
                        ),
                      ),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Expanded(child: AutoSizeText(curr['SchoolName'],style: Theme.of(context).textTheme.headlineSmall!.copyWith(color: Theme.of(context).colorScheme.secondary,fontWeight: FontWeight.bold),maxFontSize: 20,)),
                                          AutoSizeText(curr["PassingYear"],style: Theme.of(context).textTheme.headlineSmall!.copyWith(color: Theme.of(context).colorScheme.secondary,fontWeight: FontWeight.bold),maxFontSize: 20,)
                                        ],
                                      ),
                                      ...
                                      Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          AutoSizeText("$key",style: Theme.of(context).textTheme.titleMedium,maxFontSize: 20,),
                                          const Divider(height: 4,color: Colors.transparent,),
                                          AutoSizeText(curr['Board'],style: Theme.of(context).textTheme.titleMedium!.copyWith(color: Colors.grey.shade600),maxFontSize: 14,),
                                          AutoSizeText("Percentage/CGPA : ${curr["percentage"]}",style: Theme.of(context).textTheme.titleMedium!.copyWith(color: Colors.grey.shade600),maxFontSize: 14,),
                                        ],
                                      ),
                                    ],
                                  ),
        ...
        child: FilledButton(
          onPressed: () {
            ...
            if(Hive.box(userDataDB).get("interests") != null && Hive.box(qualificationDataDB).length != 0){
              try{
                AuthHandler().saveUserData(Hive.box(userDataDB).get("personalInfo")['user_id'], _name.text, _email.text, _age.text, "$city, $state, $country", _phone.text, interests.join(","));
              ...
              snackBarKey.currentState?.showSnackBar(const SnackBar(content: Text("Fill all data")));
            }
          },
          style:
          FilledButton.styleFrom(fixedSize: Size.fromWidth(MediaQuery.sizeOf(context).width)),
