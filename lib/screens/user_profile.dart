...
class _UserProfileState extends State<UserProfile> {
  final TextEditingController _name = TextEditingController(text: Hive.box(userDataDB).get("personalInfo", defaultValue: {"name": ""})["name"]);
  final TextEditingController _age = TextEditingController(text: Hive.box(userDataDB).get("personalInfo", defaultValue: {"age": ""})["age"]);
  final TextEditingController _email = TextEditingController(
    text: Hive.box(userDataDB).get("personalInfo", defaultValue: {"email": ""})["email"],
  );
  final TextEditingController _phone = TextEditingController(
    text: Hive.box(userDataDB).get("personalInfo", defaultValue: {"phone_no": ""})["phone_no"],
  );
              ...
              children: [
                ...
                Column(
                  ...
                  children: [
                    ...
                    AutoSizeText(
                      "@${Hive.box(userDataDB).get("personalInfo", defaultValue: {"user_key": ""})["user_key"]}",
        ...
        return ListView(
          ...
          children: [
            ...
            TextFormField(
              ...
              controller: _name,
              decoration: InputDecoration(label: Text(S.current.name), border: OutlineInputBorder(borderRadius: BorderRadius.circular(10))),
            ),
            const Divider(
              color: Colors.transparent,
            ),
            TextFormField(
              enabled: locationEditMode.value,
              controller: _age,
              decoration: InputDecoration(label: Text(S.current.age), border: OutlineInputBorder(borderRadius: BorderRadius.circular(10))),
            ),
            const Divider(
              color: Colors.transparent,
            ),
            TextFormField(
              controller: _email,
              enabled: locationEditMode.value,
              decoration: InputDecoration(label: Text(S.current.email), border: OutlineInputBorder(borderRadius: BorderRadius.circular(10))),
            ),
            const Divider(
              color: Colors.transparent,
            ),
            TextFormField(
              ...
              decoration: InputDecoration(label: Text(S.current.phoneNumber), border: OutlineInputBorder(borderRadius: BorderRadius.circular(10))),
            ),
            Visibility(
              visible: value,
              replacement: TextFormField(
                controller: TextEditingController(text: "${city.value}, ${state.value}, ${country.value}"),
                enabled: locationEditMode.value,
                keyboardType: TextInputType.phone,
                decoration: InputDecoration(label: Text(S.current.address), border: OutlineInputBorder(borderRadius: BorderRadius.circular(10))),
              ),
                    ...
                    children: List.generate(
                      ...
                      (index) {
                        ...
                        return ChoiceChip.elevated(
                          ...
                          showCheckmark: false,
                          labelStyle: TextStyle(fontSize: 14.sp, color: Theme.of(context).colorScheme.inverseSurface),
